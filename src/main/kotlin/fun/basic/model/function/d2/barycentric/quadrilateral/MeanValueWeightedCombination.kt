...
class MeanValueWeightedCombination: BarycentricWeightedCombination<MeanValueWeightFunction> {
    @Throws(InvalidArgumentException::class)
    constructor(
        e0: D2Point, e1: D2Point, e2: D2Point, e3: D2Point,
        e0Image: D2Point, e1Image: D2Point, e2Image: D2Point, e3Image: D2Point
    ): super(e0, e1, e2, e3, e0Image, e1Image, e2Image, e3Image, MeanValueWeightFunction(e0, e1, e2, e3))
}